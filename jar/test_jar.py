...
def test_withdraw():
        # Create a jar with a capacity of 12
    jar = Jar(12)

    # Deposit 8 cookies into the jar
    jar.deposit(8)
    print(jar)  # Output: 🍪🍪🍪🍪🍪🍪🍪🍪

    # Withdraw 5 cookies from the jar
    jar.withdraw(5)
    print(jar)  # Output: 🍪🍪🍪🍪🍪🍪

    # Try to withdraw 4 more cookies than the current amount (invalid)
    try:
        jar.withdraw(9)
    except ValueError as e:
        print(str(e))  # Output: invalid withdraw
